...
#let template(body) = {
  ...
  // Pemisah caption mengikuti berkas resmi:
  //   Gambar 4.1 Keterangan   |   Tabel 4.1 Judul   |   Kode Sumber 5.1. Deskripsi
  set figure.caption(separator: [ ])
  show figure.where(kind: "kode"): set figure.caption(separator: [. ])
